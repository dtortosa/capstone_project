...
\begin{frame}{Improving genetic prediction for genetic-testing consumers}
    ...
    \begin{block}{Relevance of genetics}
        ...
        \begin{itemize}
            ...
            \item{Gaps in the knowledge about specifics genetic determinants}
    ...
    \begin{figure}
        \begin{center}
            ...
            %add figure
            \hspace*{0.3cm}\includegraphics[page=1, trim={0 0 0 0}, clip=true, width=0.65\paperwidth,height=0.45\paperheight]{figures/figure_1/figure_1.png}
            \vspace*{0cm} %Eye figure: https://commons.wikimedia.org/wiki/File:A_close_up_of_a_blue-green_human_iris_(with_visible_freckle)..jpg; DNA molecule: https://www.vecteezy.com/vector-art/2454025-red-dna-molecule 
...
\begin{frame}{Improving genetic prediction for genetic-testing consumers}
    ...
    \begin{figure}
        \begin{center}
            ...
            %add figure
            \hspace*{0.3cm}\includegraphics[page=1, trim={0 0.3cm 0 1.5cm}, clip=true, width=0.5\paperwidth,height=0.57\paperheight]{figures/height_density_plot.jpeg}
            \vspace*{0cm}
...
\begin{frame}{Improving genetic prediction for genetic-testing consumers}
    ...
    \begin{block}{Genetic algorithms to predict height}
        ...
        \begin{itemize}
            \item{Genetic algorithms selecting best genetic variants}
                \begin{itemize}
                    \item{Filtering by p-value (from gene-height association)}
    ...
    \begin{figure}
        \begin{center}
            ...
            %add figure
            \hspace*{0.3cm}\includegraphics[page=1, trim={0 0 0 0}, clip=true, width=0.6\paperwidth,height=0.4\paperheight]{figures/figure_1/figure_1.png}
            \vspace*{0cm} %Eye figure: https://commons.wikimedia.org/wiki/File:A_close_up_of_a_blue-green_human_iris_(with_visible_freckle)..jpg; DNA molecule: https://www.vecteezy.com/vector-art/2454025-red-dna-molecule 
...
\begin{frame}{Improving genetic prediction for genetic-testing consumers}
    ...
    \begin{block}{Proof of concept}
        ...
        \begin{itemize}
            ...
            \item{Future testing on larger datasets with clinical data}
