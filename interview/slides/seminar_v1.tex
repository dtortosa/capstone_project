...
\begin{frame}{Improving genetic prediction for genetic-testing consumers}
    ...
    \begin{figure}
        \begin{center}
            ...
            %add figure
            \hspace*{0.3cm}\includegraphics[page=1, trim={0 1.2cm 0 1.5cm}, clip=true, width=0.55\paperwidth,height=0.55\paperheight]{figures/height_density_plot.jpeg}
            \vspace*{0cm}
            
            %add footnote
            \vspace*{-0.15cm}\hspace*{0.2cm}\scriptsize User's height in cm
        \end{center}            
    \end{figure}
\end{frame}
